...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        let rolefetched = wiodb.fetch(`muteeid_${message.guild.id}_${mutee.id}`)
        ...
        const sembed = new MessageEmbed()
            .setColor("GREEN")
            .setDescription(`_**✅${mutee.user.username} was successfully unmuted.**_`)
        ...
        var logChannel = message.guild.channels.cache.get('') // channel id
